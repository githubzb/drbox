...
- (NSString *)dr_hmacMD5StringWithKey:(NSString *)key{
    return [self dr_hmacStringUsingAlg:kCCHmacAlgMD5 withKey:key];
}
- (NSData *)dr_hmacMD5DataWithKey:(NSString *)key{
    return [self dr_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}
- (NSString *)dr_hmacSHA224StringWithKey:(NSString *)key{
    return [self dr_hmacStringUsingAlg:kCCHmacAlgSHA224 withKey:key];
}
- (NSData *)dr_hmacSHA224DataWithKey:(NSString *)key{
    return [self dr_hmacDataUsingAlg:kCCHmacAlgSHA224 withKey:key];
}
- (NSString *)dr_hmacSHA256StringWithKey:(NSString *)key{
    return [self dr_hmacStringUsingAlg:kCCHmacAlgSHA256 withKey:key];
}
- (NSData *)dr_hmacSHA256DataWithKey:(NSString *)key{
    return [self dr_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}
- (NSString *)dr_hmacSHA384StringWithKey:(NSString *)key{
    return [self dr_hmacStringUsingAlg:kCCHmacAlgSHA384 withKey:key];
}
- (NSData *)dr_hmacSHA384DataWithKey:(NSString *)key{
    return [self dr_hmacDataUsingAlg:kCCHmacAlgSHA384 withKey:key];
}
- (NSString *)dr_hmacSHA512StringWithKey:(NSString *)key{
    return [self dr_hmacStringUsingAlg:kCCHmacAlgSHA512 withKey:key];
}
- (NSData *)dr_hmacSHA512DataWithKey:(NSString *)key{
    return [self dr_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}
...
- (NSData *)dr_aes256EncryptWithKey:(NSData *)key iv:(NSData *)iv{
...
- (NSData *)dr_aes256DecryptWithkey:(NSData *)key iv:(NSData *)iv{
    if (key.length != 16 && key.length != 24 && key.length != 32) {
        return nil;
    }
    if (iv.length != 16 && iv.length != 0) {
...
- (id)dr_jsonObj{
    ...
    if (error) {
        NSLog(@"dr_jsonObj error:%@", error);
    }
    return value;
}

- (NSData *)dr_gzipDeflate{
...
#pragma mark - private
- (NSString *)dr_hmacStringUsingAlg:(CCHmacAlgorithm)alg withKey:(NSString *)key {
    size_t size;
    switch (alg) {
